...
## Auto Trading TradingView -> Binance Futures

Fitur baru:

- Endpoint `POST /api/tradingview/webhook`
- Support RSA Binance API key
- Support Futures USDT-M
- Mode aman `AUTO_TRADE_ENABLED=false` dan `DRY_RUN=true`
- Baca panduan lengkap di `PANDUAN_AUTO_TRADING_BINANCE.md`

Contoh test webhook lokal:
